  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
          ...
          <div className="mb-16 flex justify-center">
            <img 
              ...
              className="h-24 w-auto opacity-90 hover:opacity-100 transition-opacity duration-500"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button 
              size="lg" 
              className="px-12 py-4 text-lg font-semibold bg-primary text-white hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="px-12 py-4 text-lg font-semibold border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all duration-300 transform hover:scale-105"
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              <div className="absolute -top-8 -left-8 w-24 h-24 border-4 border-gray-200 rotate-45"></div>
              <ImageWithFallback
              ...
              />
              <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-gray-100 rounded-full blur-xl"></div>
            </div>
            
            <div className="space-y-8">
              <div className="text-lg text-gray-500 font-semibold tracking-widest uppercase">
                Our Philosophy
              </div>
              ...
              <Button 
                ...
                className="bg-primary hover:bg-gray-800 text-white px-8 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105"
              >
                Meet the Founder →
              </Button>
            </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 group">
      ...
      <section className="py-32 bg-primary text-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <div className="text-lg text-gray-300 font-semibold tracking-widest uppercase mb-4">
              From Sketch to Soul
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
              <h3 className="text-xl font-bold mb-4">Why size isn't everything</h3>
              <p className="text-gray-300 leading-relaxed">
                Designing for flow, not footage — how smart planning makes small spaces feel larger.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
              <h3 className="text-xl font-bold mb-4">Common Design Mistakes</h3>
              <p className="text-gray-300 leading-relaxed">
